        ...
        try:
            ...
            if not isinstance(products,list) or len(products) == 0:
                return Response(
                    {
                        "status": "fail",
                        "message": f"{BAD_REQUEST} - Products are required"
                    },
            ...
            if request_product_ids != cart_product_ids:
                return Response(
                    {
                        "status": "fail",
                        "message": f"{BAD_REQUEST} - Cart products mismatch"
                    },
                    status=status.HTTP_400_BAD_REQUEST
                )
            ...
            with transaction.atomic():
                        ...
                        return Response(
                            {
                                ...
                                "message": (
                                    f"{BAD_REQUEST} - "
                                    f"Only {product.stock} stock left "
                                    f"for {product.name}"
                                )
                            },
                            status=status.HTTP_400_BAD_REQUEST
                ...
                for item in cart_items:
                    ...
                    order_items_response.append({
                            ...
                            "price_details": {
                                ...
                                "price_per_quantity": float(selling_price)
                            },
                ...
                whatsapp_message = (
                    ...
                    f"Customer Name : {shipping_address.contact_name}\n"
                    f"Mobile Number : {shipping_address.contact_no}\n"
                    f"Address : "
                    f"{shipping_address.house_no}, "
                    f"{shipping_address.area_street}, "
                    ...
                    f"Shipping Charge : ₹{order.shipping_charge}\n"
